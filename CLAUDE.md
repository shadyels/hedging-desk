...
| `docs/adr/` (ADR-001…013) | touching anything an ADR governs: bus (001), post-trade (002), FIX (003), hot path (004), netting/crosses (005), models/products (006), tooling (007), Greeks ladder (008), proposals/transfers (009), tracker analytics (010), AI assistance (011, Proposed), codegen plugin tooling (012), SPSC queue choice (013). ADRs are binding; read the relevant one in full |
